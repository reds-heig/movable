...
HEADERS += movable_ui.h frame_image_viewer.h item_parasit.h item_erythrocyte.h item_image.h
HEADERS += cv_functions.h
HEADERS += model_simulation.h model_blood_image.h model_parasit.h model_erythrocyte.h

SOURCES += main.cpp movable_ui.cpp frame_image_viewer.cpp item_parasit.cpp item_erythrocyte.cpp item_image.cpp
